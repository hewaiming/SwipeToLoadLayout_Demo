...
public class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.MyViewHolder> {
    ...
    private final List<City> mDatas;
    private OnItemClickListener mOnItemClickListener;
    private OnItemLongClickListener mOnItemLongClickListener;


    public HomeAdapter(List<City> mDatas) {
        this.mDatas = mDatas;
    }
    ...
    public void append(City m_city) {
        mDatas.add(m_city);
        notifyDataSetChanged();
    }

    public void addDate(int position, City m_id) {
    ...
    public void setList(List<City> mData) {
        mDatas.clear();
        mDatas.addAll(mData);
        notifyDataSetChanged();
    }
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        holder.tv_id.setText(mDatas.get(position).getId());
